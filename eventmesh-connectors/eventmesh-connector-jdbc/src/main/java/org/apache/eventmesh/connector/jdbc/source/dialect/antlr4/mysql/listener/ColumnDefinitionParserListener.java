...
public class ColumnDefinitionParserListener extends MySqlParserBaseListener {
    ...
    public ColumnDefinitionParserListener(List<ParseTreeListener> listeners, TableEditor tableEditor, ColumnEditor columnEditor,
    ...
    public void enterPrimaryKeyColumnConstraint(PrimaryKeyColumnConstraintContext ctx) {
        //include primary key and key
        ignoreColumn.set(true);
