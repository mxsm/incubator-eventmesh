...
public class UpdateDataEvent extends GeneralDataChangeEvent {

    public UpdateDataEvent(TableId tableId) {
        super(tableId);
    }

    public UpdateDataEvent(TableId tableId, JdbcConnectData data) {
        super(tableId, data);
    }
