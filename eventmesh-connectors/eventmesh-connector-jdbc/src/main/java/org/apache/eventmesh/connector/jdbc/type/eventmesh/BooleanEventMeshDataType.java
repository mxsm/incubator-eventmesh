...
public class BooleanEventMeshDataType extends AbstractType<Boolean> {

    public static final BooleanEventMeshDataType INSTANCE = new BooleanEventMeshDataType();

    private BooleanEventMeshDataType() {
    ...
    public List<String> ofRegistrationKeys() {
        return Arrays.asList("boolean", "bool", getName(), "BOOL");
    }
